...
class AlertsViewModel(app: App) : MeowViewModel(app) {
    ...
    fun fillList() {
        ...
        val titles = app.getStringArray(R.array.alerts_contents_list_title)
        val descs = app.getStringArray(R.array.alerts_contents_list_desc)
