...
/**
 * Material Snack Bars View Model.
 *
...
class SnackBarsViewModel(app: App) : MeowViewModel(app) {
    ...
    fun fillList() {
        ...
        val titles = app.getStringArray(R.array.snackbars_contents_list_title)
        val descs = app.getStringArray(R.array.snackbars_contents_list_desc)
