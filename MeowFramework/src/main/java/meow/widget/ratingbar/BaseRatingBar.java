...
public class BaseRatingBar extends LinearLayout implements SimpleRatingBar {
    ...
    public BaseRatingBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.MeowRatingBar);
        final float rating = typedArray.getFloat(R.styleable.MeowRatingBar_meow_rating, 0);
    ...
    private void initParamsValue(TypedArray typedArray, Context context) {
        mNumStars = typedArray.getInt(R.styleable.MeowRatingBar_meow_numStars, mNumStars);
        mStepSize = typedArray.getFloat(R.styleable.MeowRatingBar_meow_stepSize, mStepSize);
        mMinimumStars = typedArray.getFloat(R.styleable.MeowRatingBar_meow_minimumStars, mMinimumStars);
        mPadding = typedArray.getDimensionPixelSize(R.styleable.MeowRatingBar_meow_starPadding, mPadding);
        mStarWidth = typedArray.getDimensionPixelSize(R.styleable.MeowRatingBar_meow_starWidth, 0);
        mStarHeight = typedArray.getDimensionPixelSize(R.styleable.MeowRatingBar_meow_starHeight, 0);
        mEmptyDrawable = typedArray.hasValue(R.styleable.MeowRatingBar_meow_drawableEmpty) ? ContextCompat.getDrawable(context, typedArray.getResourceId(R.styleable.MeowRatingBar_meow_drawableEmpty, View.NO_ID)) : null;
        mFilledDrawable = typedArray.hasValue(R.styleable.MeowRatingBar_meow_drawableFilled) ? ContextCompat.getDrawable(context, typedArray.getResourceId(R.styleable.MeowRatingBar_meow_drawableFilled, View.NO_ID)) : null;
        mIsIndicator = typedArray.getBoolean(R.styleable.MeowRatingBar_meow_isIndicator, mIsIndicator);
        mIsScrollable = typedArray.getBoolean(R.styleable.MeowRatingBar_meow_scrollable, mIsScrollable);
        mIsClickable = typedArray.getBoolean(R.styleable.MeowRatingBar_meow_clickable, mIsClickable);
        mClearRatingEnabled = typedArray.getBoolean(R.styleable.MeowRatingBar_meow_clearRatingEnabled, mClearRatingEnabled);
        typedArray.recycle();
    }
