...
[ ![Download](https://api.bintray.com/packages/infinitydesign/meow/Meow-Framework-MVVM/images/download.svg?version=0.6.3-alpha) ](https://bintray.com/infinitydesign/meow/Meow-Framework-MVVM/0.6.3-alpha/link)
  
## 🛠 Setup

```groovy
implementation("com.etebarian:meow-framework-mvvm:0.6.3-alpha")
```
...
We suggest you to install [Meow-Sample.apk](https://github.com/oneHamidreza/Meow-Framework-MVVM/releases/download/v0.6.3-alpha/Meow-Framework-Sample-v.0.6.3-alpha.apk) to be familiar with `Meow Framework`.
