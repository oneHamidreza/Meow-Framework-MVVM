...
We suggest you to install [Meow-Sample.apk](https://github.com/oneHamidreza/Meow-Framework-MVVM/releases/download/v0.7.5-alpha/Meow-Framework-Sample-v0.7.5-alpha.apk) to be familiar with `Meow Framework`.
...
```groovy
implementation("com.etebarian:meow-framework-mvvm:0.7.5-alpha")
```
...
The Sample Application has above features. try to install [Meow-Sample.apk](https://github.com/oneHamidreza/Meow-Framework-MVVM/releases/download/v0.7.5-alpha/Meow-Framework-Sample-v0.7.5-alpha.apk) .
