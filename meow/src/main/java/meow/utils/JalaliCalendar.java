...
public class JalaliCalendar extends Calendar {
    ...
    public static final int[] gregorianDaysInMonth = {31, 28, 31, 30, 31,
            30, 31, 31, 30, 31, 30, 31};
    public static final int[] jalaliDaysInMonth = {31, 31, 31, 31, 31, 31,
            30, 30, 30, 30, 30, 29};
    ...
    public JalaliCalendar() {
        this(TimeZone.getDefault(), Locale.getDefault(), -1);
    }

    public JalaliCalendar(long timestamp) {
        this(TimeZone.getDefault(), Locale.getDefault(), timestamp);
    }

    public JalaliCalendar(TimeZone zone) {
        this(zone, Locale.getDefault(), -1);
    }

    public JalaliCalendar(Locale aLocale) {
        this(TimeZone.getDefault(), aLocale, -1);
    }

    public JalaliCalendar(TimeZone zone, Locale aLocale, long timestamp) {
