...
class MeowEmptyState @JvmOverloads constructor(
    ...
    var iconTint: ColorStateList = ColorStateList.valueOf(context.getColorCompat(R.color.primary))
    ...
    init {
        ...
        setAttributesFromXml(attrs, R.styleable.MeowEmptyState) {
            icon = it.getDrawable(R.styleable.MeowEmptyState_empty_iconRes) ?: icon
